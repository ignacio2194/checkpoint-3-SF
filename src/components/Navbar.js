...
const Navbar = () => {
  return (
    <nav className="navbar navbar-expand-sm navBarContainer">
          ...
          <div className="offcanvas-body">
            <ul className="navbar-dark ms-auto text-light">
              <Link to="/createbook" className="text-light ms-auto">
                <li className="btnNavbar">Add book<span>Lets go!</span></li>
              </Link>
              <Link to="/login" className="text-light ms-auto">
                <li className="btnNavbar">Login<span>Hi!</span></li>
              </Link>
              <Link to="/register" className="text-light ms-auto">
                <li className="btnNavbar">Register<span>SingIn</span></li>
              </Link>
            </ul>
          </div>
        </div>
